...
export default function MobilePageShell({
  ...
  return (
    <div
      className="fixed inset-0 z-40 flex flex-col w-full max-w-[100vw] overflow-hidden bg-white dark:bg-zinc-900"
      data-testid={testId}
    >
      <div className="flex flex-col flex-1 min-h-0 w-full md:max-w-3xl md:mx-auto">
