  ...
  return (
    ...
    >
      <div
        ...
        style={{ ...BUBBLE_WRAP_STYLE, ...NO_SELECT_STYLE }}
      >
        {selected && (
          <>
            <div
        ...
        <div style={{ display: "flex", flexDirection: "column", minWidth: 0 }}>
          ...
          {message.content && message.message_type !== "audio" ? (
            <span
              className="message-text text-sm text-gray-900 dark:text-gray-100 leading-relaxed"
              style={{ ...TEXT_STYLE, minWidth: 0, display: "block" }}
            >
